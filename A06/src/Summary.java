...
public class Summary {
    ...
    /**
     * Read and store People and their stats from CSV file
     * skips the header
     * creates an ArrayList of Person objects by iterating through the whole file
     * each line is seperated by commas into variables/array
     * Person constructor is called using these new values
     * That Person is then added to the ArrayList alp
     * mthod created to remove repeated code
     * 
     * @param file
     * @return alp
    ...
    /**
     * Accepts a file to read using loadPeople()
     * sortby to determine the way to organize the ArrayList
     * reverse will evaluate whether to apply the reverse method at the end
     * the ArrayList is created, then the second argument is iterated over
     * to decide which comparartor to call from the Person class
     * reverse is evaluated
     * Finally print the sorted Person objects in the ArrayList
     * 
     * @param file
     * @param sortBy
     * @param reverse
    ...
    /**
     * print a summary of the file given
     * calls loadPeople to create an ArrayList
