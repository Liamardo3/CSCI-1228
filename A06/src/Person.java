 ...
 *
 * A person with attributes such as name, sex, age, height, and weight.
 * Includes methods to get various statistics, such as the youngest, oldest,etc.
 * Implements Comparable for sorting by name and provides comparators for 
 * sorting by name, age, and height
 * 
